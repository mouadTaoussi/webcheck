			...
			<div id="header-column-2">
				<ul class="header-list-2 poppins">
					<router-link to="/login" tag="li">
						<button
							class="local-btn bg-primary text-white local-shadow"
						>
							Log in
						</button>
					</router-link>
					...
					<a
						target="_blank"
						href="https://github.com/mouadTaoussi/webcheck"
					>
				...
				<svg
					...
					height="1em"
					viewBox="0 0 16 16"
					class="bi bi-justify hamburger-menu"
					fill="currentColor"
...
export default {
	...
	methods: {
		toggleMenu: function() {
			// Get menu
			const side_menu = document.querySelector(
